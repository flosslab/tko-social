...
class MailMail(models.Model):
    ...
    email_bcc = fields.Char(
        string="Bcc",
        help="Black Carbon copy message recipients"
    )
    ...
    def send(self, auto_commit=False, raise_exception=False):
        ...
        for mail in self:
            try:
                ...
                attachments = []
                for attachment in mail.attachment_ids.sudo().read(["datas_fname", "datas", "mimetype"]):
                    attachments.append(
                        (attachment["datas_fname"], base64.b64decode(attachment["datas"]), attachment["mimetype"])
                    )
